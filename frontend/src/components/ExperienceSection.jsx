  ...
  <div className="max-w-6xl mx-auto space-y-12">
    ...
    <div className="flex flex-col md:flex-row gap-8 border border-[#1DCD9F] p-6 rounded-2xl items-center">
      ...
      <div className="flex-1">
        ...
        <p className="text-gray-300 mb-1">Project Intern <span className="text-sm text-[#1DCD9F]">(Chanakya Fellowship)</span></p>
        <p className="text-sm text-gray-400 mb-4">Dec 2024 – Present</p>
        <ul className="list-disc pl-5 space-y-2 text-gray-200">
          <li>Designed a VAE + 1D-CNN classification model <span className="text-sm text-[#1DCD9F]">
            <a href={model} target='_blank'  rel="noopener noreferrer">(Architechture)</a>
        </span> for tool condition monitoring</li>
      ...
      <div className="w-full md:w-1/3 flex-shrink-0">
        <img 
          src={tih} 
          alt="TIH IoT Project" 
          className="rounded-xl shadow-lg w-full object-cover max-h-52" 
        />
      </div>
    </div>
    ...
    <div className="flex flex-col md:flex-row gap-8 border border-[#1DCD9F] p-6 rounded-2xl items-center">
      ...
      <div className="flex-1">
        ...
        <p className="text-gray-300 mb-1">Data Analyst Intern <span className="text-sm text-[#1DCD9F]">
            <a href="https://drive.google.com/file/d/1AWiBOUUN-NarYamaGn-LQZHlys-pVqcX/view" target='_blank'>(Star Intern Award)</a>
        </span></p>
